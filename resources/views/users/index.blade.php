            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <!-- <a href="{{route('users.create')}}" ><button class="btn btn-primary shadow-md mr-2">Add New Users</button></a> -->
                        <div class="dropdown">
                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Role Name</th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Mail</th>
