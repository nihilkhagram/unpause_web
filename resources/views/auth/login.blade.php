...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light" >
    ...
    <head>
        <meta charset="utf-8">
        <link href="<?php echo $baseurl; ?>/assets/images/logo.svg" rel="shortcut icon">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="Rubick admin is super flexible, powerful, clean & modern responsive tailwind admin template with unlimited possibilities.">
        <meta name="keywords" content="admin template, Rubick Admin Template, dashboard template, flat admin template, responsive admin template, web app">
        <meta name="author" content="LEFT4CODE">
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <title>Login - RUMedical</title>
        <!-- BEGIN: CSS Assets-->
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <!-- <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="RUMedical" class="w-6" src="<?php echo $baseurl; ?>/assets/images/logo.svg">
                        <span class="text-white text-lg ml-3">
                        RU<span class="font-medium">Medical</span>
                        </span>
                    </a> -->
                    <div class="my-auto">
                        <img alt="RUMedical" class="-intro-x w-1/2 -mt-16" src="<?php echo $baseurl; ?>/assets/images/illustration.svg">
                ...
                <div>
                <img class="" style="margin-left:120px;margin-bottom:55px;" src="<?php echo $baseurl; ?>/assets/images/hm_logo.png" height="100px;" width="100px";  >
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="intro-x mt-8">
                                <input type="text" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="Email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left" style="display:none;">
