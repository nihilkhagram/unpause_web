            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a href="{{URL::to('/post/create')}}"><button class="btn btn-primary shadow-md mr-2">Add New Post</button></a>
                        <div class="dropdown">
                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
									...
									<!--<th class="text-center whitespace-nowrap">Stock Qty</th>-->
									 <th class="text-center whitespace-nowrap"> Title</th>
									<th class="text-center whitespace-nowrap">Short Desc</th>
                                    <th class="text-center whitespace-nowrap">Long Desc</th>
                                   <th class="text-center whitespace-nowrap">Video</th>
                                <th class="text-center whitespace-nowrap">Approve Status</th>
                                  <th class="text-center whitespace-nowrap">Reward Points</th>
            ...
            $("#sample_3").DataTable({
                ...
                "columns": [
							...
							// //{ "data": "Stock_qty" },
							 ...
							 { "data": "long_desc" },
                             //{ "data": "videos" },
                             { "data": "videos" ,render: function( data, type, full, meta ) {

                                if(data == "" || data == null)
                                {
                                    return "N/A";
                                }else{
                                return "<iframe src={{URL::to('/')}}/" + data + " /></iframe>";
                                }
                                //return '<video width="160" height="120" controls><source src="{{URL::to('/')}}/public/" + data + "></video>';
...
function approve_status_change(value,id)
{
    ...
    if(value=="Rejected")
	{
        //window.$('#cancelation-modal').modal();
