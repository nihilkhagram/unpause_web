            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a href="{{URL::to('/category/create')}}"><button class="btn btn-primary shadow-md mr-2">Add New Category</button></a>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu w-40">
                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                    <a href="" id="print_btn" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="printer" class="w-4 h-4 mr-2"></i> Print </a>
		  
          <a href="" id="excel_btn" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> Export to Excel </a>
		  
          <a href="" id="pdf_btn" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> Export to PDF </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Category Title</th>
									<th class="text-center whitespace-nowrap">Category Short Info</th>
				...
				<!--H-->
				<div id="stack2" style="margin-top:80px;" class="modal fade" tabindex="-2" data-width="400">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<img width="570" height="400" controls>
							<source src="" id="image_play">
						</img>
					</div>
				</div>
			</div>
        ...
        $("#sample_3").DataTable().destroy();
            $("#sample_3").DataTable({
				...
				"columnDefs": [
				   ...
				   buttons: [
                    ...
                    // 'pdfHtml5'
                    {
                        ...
                        exportOptions: {
                            columns: [0, 1, 2, 3,4 ] //Your Column value those you want,remove this line if you want to get pdf of all coloumn
                        },
                ...
                "columns": [
                            ...
                            { "data": "id" },
                            { "data": "category_name" },
							{ "data": "category_short_info" },
							{ "data": "category_image" ,render: function( data, type, full, meta ) {
							...
							/*{ "data": "parent_id",render: function( data, type, full, meta ) {
								if(data == "" || data == null)
								{
									return "N/A";
								}else{
...
$(document).ready(function(){   
	...
	$('.placeholder-theme-13').on('keyup', function () {
...
function show_image(id) 
	{
		...
		var full_path = id;
		$("#stack2").modal('show');
		$('#stack2 image').attr('src', full_path);
