                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Smoking</th>
                                   <th class="text-center whitespace-nowrap">Drinking</th>
                                <th class="text-center whitespace-nowrap">Exercise</th>
                                  <th class="text-center whitespace-nowrap">Pdf Generated Date</th>
                                  <th class="text-center whitespace-nowrap">Hot Flashes</th>
                                   ...
                                   <th class="text-center whitespace-nowrap">Physchological</th>
                                <th class="text-center whitespace-nowrap">Physical</th>
                               <th class="text-center whitespace-nowrap">Last Period</th>
                           <th class="text-center whitespace-nowrap">Cycle Changed</th>
                                   <th class="text-center whitespace-nowrap">Heavier Bleeding</th>
                                <th class="text-center whitespace-nowrap">My Management</th>
                               <th class="text-center whitespace-nowrap">Hrt routine</th>
