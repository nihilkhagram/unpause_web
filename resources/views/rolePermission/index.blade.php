            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a href="{{route('rolePermission.create')}}"><button class="btn btn-primary shadow-md mr-2">Add Role&Permission</button></a>
                        <div class="dropdown">
                                        ...
                                        <input type="hidden" name="search_input" id="search_input" value="">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group m-b" style="width:180px !important;">
                                                    ...
                                                    <select name="created_by" class="form-control created_by" style="display:none;">
                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-nowrap">RoleName</th>
...
function datatablefilter(){
          ...
          var viewid = 'rolepermission_filter';
