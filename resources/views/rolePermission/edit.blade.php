...
<!-- BEGIN: Content -->
	<div class="content">
		<!-- BEGIN: Top Bar -->
		@include('topbar',['page_name'=>'Edit Role'])
		<!-- END: Top Bar -->
		...
		<div class="grid grid-cols-12 gap-6 mt-5"	>
			...
			<div class="intro-y col-span-12 lg:col-span-12">
				...
				<div class="intro-y box p-5">
					...
					{!! Form::open(['route' => ['rolePermission.update',$role_name->id],'id' => 'form_sample_2', 'class' => 'form-horizontal form-row-seperated', 'files' => true ,'method'=> 'post','enctype' => 'multipart/form-data']) !!}
                    @method('put')
