            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a href="{{URL::to('/test/create')}}"><button class="btn btn-primary shadow-md mr-2">Add New Test</button></a>
                        <div class="dropdown">
                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
									...
									<th class="text-center whitespace-nowrap">Connected</th>
									 <th class="text-center whitespace-nowrap"> Disconnected</th>
									<th class="text-center whitespace-nowrap">Firmware</th>
                                    <th class="text-center whitespace-nowrap">Battery Level</th>
                                   <th class="text-center whitespace-nowrap">TemperatureValue</th>
                                <th class="text-center whitespace-nowrap">DateAndTime Value</th>
                                  <th class="text-center whitespace-nowrap">Alert Level</th>
                                  <th class="text-center whitespace-nowrap"> Alert Status</th>
									<th class="text-center whitespace-nowrap">Manufacturer Name</th>
                                    <th class="text-center whitespace-nowrap">Model Number</th>
                                   <th class="text-center whitespace-nowrap">SerialNumber</th>
                                <th class="text-center whitespace-nowrap">Temperature</th>
