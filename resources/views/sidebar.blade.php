            ...
            <ul class="border-t border-theme-29 py-5 hidden">
                <li>
                    <a href="<?php echo $baseurl; ?>" class="menu {{ Request::segment(1) === '' ? 'menu--active' : '' }}">
                        ...
                        <div class="menu__title"> Dashboard 1 </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:;" class="menu {{ Request::segment(1) === 'floor' ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-feather="box"></i> </div>
                        <div class="menu__title"> Floor Management <i data-feather="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="<?php echo $baseurl; ?>/floor" class="menu {{ Request::segment(1) === 'floor' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Floor List 12 </div >
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $baseurl; ?>/floor/create" class="menu {{ Request::segment(1) === 'floor' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Add Floor </div>
                            </a>
                        </li>
				...
				<li>
                    <a href="javascript:;" class="menu {{ Request::segment(1) === 'lift_type' ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-feather="box"></i> </div>
                        <div class="menu__title"> Lift Type <i data-feather="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="<?php echo $baseurl; ?>/lift_type" class="menu {{ Request::segment(1) === 'lift_type' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Lift Type List </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $baseurl; ?>/lift_type/create" class="menu {{ Request::segment(1) === 'lift_type' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Add Lift Type </div>
                            </a>
                        </li>
				...
				<li>
                    <a href="javascript:;" class="menu {{ Request::segment(1) === 'lift_machine' ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-feather="box"></i> </div>
                        <div class="menu__title"> Lift Machine <i data-feather="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="<?php echo $baseurl; ?>/lift_machine" class="menu {{ Request::segment(1) === 'lift_machine' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Lift Machine List </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $baseurl; ?>/lift_machine/create" class="menu {{ Request::segment(1) === 'lift_machine' ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Add Lift Machine </div>
                            </a>
                        </li>
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu {{ Request::segment(1) === 'floor' ? 'side-menu--active side-menu--open' : '' }}">
                            <div class="side-menu__icon"> <i data-feather="box"></i> </div>
                            <div class="side-menu__title"> Floor Menagement <i data-feather="chevron-down" class="side-menu__sub-icon "></i> </div>
                        </a>
                        <ul class="{{ Request::segment(1) === 'floor' ? 'side-menu__sub-open' : '' }}">
                            <li>
                                <a href="<?php echo $baseurl; ?>/floor" class="side-menu {{ Request::segment(1) === 'floor' ? 'side-menu--active' : '' }}">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Floor List </div>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo $baseurl; ?>/floor/create" class="side-menu {{ Request::segment(1) === 'floor' & Request::segment(2) === 'create' ? 'side-menu--active' : '' }}">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
