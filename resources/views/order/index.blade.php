                        ...
                        <table class="table table-report -mt-2 order-column" id="sample_3">
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Tax</th>
                                    <th class="text-center whitespace-nowrap">Shipping</th>
                                    ...
                                    <th class="text-center whitespace-nowrap">Promocode</th>
...
function statuschange(id)
        {
            $.ajax({
                ...
                data: {
                    _token: "{{csrf_token()}}",
                    status: $(".order_status_"+id).find(':selected').val(),
                    id: id,
                },
                dataType: "JSON",
