            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <!-- <a href="{{URL::to('/report/create')}}"><button class="btn btn-primary shadow-md mr-2">Generate New Report</button></a> -->
                        <div class="dropdown">
                            ...
                            <thead>
								...
								<th><center><input type="checkbox" id="selectchkall" class="form-check-input flex-none allchecksel" /></center></th>
									...
									<th class="text-center whitespace-nowrap">First Name</th>
									 <th class="text-center whitespace-nowrap">Birth Year</th>
									<th class="text-center whitespace-nowrap">Ethnic Origin</th>
                                    <th class="text-center whitespace-nowrap">Country Of Residence</th>
                                   <th class="text-center whitespace-nowrap">Height</th>
                                <th class="text-center whitespace-nowrap">Weight</th>
                                  <th class="text-center whitespace-nowrap">Changes Weight</th>
                                  <th class="text-center whitespace-nowrap">Often excercise</th>
									<th class="text-center whitespace-nowrap">excercise Patterns Changes</th>
                                    <th class="text-center whitespace-nowrap">often Consume Alcohol</th>
                                   <th class="text-center whitespace-nowrap">Smoke</th>
                                <th class="text-center whitespace-nowrap">Period</th>
                               <th class="text-center whitespace-nowrap">Last Period Date</th>
									<th class="text-center whitespace-nowrap">Hot Flashes</th>
									 <th class="text-center whitespace-nowrap">Occur Hf</th>
									<th class="text-center whitespace-nowrap">Night Sweats</th>
                                    <th class="text-center whitespace-nowrap">Cold Flashes</th>
                                   <th class="text-center whitespace-nowrap">Occur Cf</th>
                                <th class="text-center whitespace-nowrap">Affect Sleep</th>
                                  <th class="text-center whitespace-nowrap">Is Symptoms1</th>
                                  <th class="text-center whitespace-nowrap">Is Symptoms2</th>
									<th class="text-center whitespace-nowrap">experience Symptoms</th>
                                    <th class="text-center whitespace-nowrap">Spoken Abt Menopausal</th>
                                   <th class="text-center whitespace-nowrap">cycle Lengths changed recently</th>
                                <th class="text-center whitespace-nowrap">Duration Period Changed</th>
                                <th class="text-center whitespace-nowrap">Bleeding Been Heavier Period</th>
                                  <th class="text-center whitespace-nowrap">Occur Ns</th>
                                  <th class="text-center whitespace-nowrap">NHS Or Private Healthcare</th>
									<th class="text-center whitespace-nowrap">whom Did You Consult</th>
                                    <th class="text-center whitespace-nowrap">received Diagnosis Healthcare Professional</th>
                                   <th class="text-center whitespace-nowrap">On hormone replacement Therapy</th>
                                   <th class="text-center whitespace-nowrap">which form of HRT are you on</th>
                                    <th class="text-center whitespace-nowrap">Type of HRT routine are you on</th>
                                   <th class="text-center whitespace-nowrap">Type of cyclic HRT routine are you on</th>
        ...
        $("#sample_3").DataTable().destroy();
            $("#sample_3").DataTable({
                ...
                "columns": [
                            ...
                            { "data": "weight" },
							{ "data": "changes_weight" },
							 { "data": "often_excercise" },							
							 { "data": "excercise_patterns_changes" },
							 { "data": "often_consume_alcohol" },
                              { "data": "smoke" },
                             { "data": "period" },
                            ...
                            { "data": "is_symptoms1" },
							{ "data": "is_symptoms2" },
							 { "data": "experience_symptoms" },							
							 { "data": "spoken_abt_menopausal" },
							 { "data": "cycle_lengths_changed_recently" },
                              { "data": "duration_period_changed" },
                             { "data": "bleeding_been_heavier_period" },
                             { "data": "occur_ns" },							
							 { "data": "nhs_or_private_healthcare" },
							 { "data": "whom_did_you_consult" },
                              { "data": "received_diagnosis_healthcare_professional" },
                             { "data": "on_hormone_replacement_therapy" },
                          { "data": "which_form_of_HRT_are_you_on" },
                              { "data": "type_of_HRT_routine_are_you_on" },
                             { "data": "type_of_cyclic_HRT_routine_are_you_on" },
                            // { "data": "login_id" },
                            { "data": "created_at" },
                            { "data": "status" },
                            //   { "data": "action" },
