...
class CreateTblLopCopTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_lop_cop_type', function (Blueprint $table) {
            ...
            $table->enum('lop_cop_type', ['lop', 'cop']);
    ...
    {
        Schema::dropIfExists('tbl_lop_cop_type');
    }
}
